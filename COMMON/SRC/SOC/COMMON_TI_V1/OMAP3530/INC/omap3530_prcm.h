...
#ifndef __OMAP3530_PRCM_H
#define __OMAP3530_PRCM_H
...
#define SMPS_SR2_IN_TRANSITION			(1 << 6)
#define SMPS_SR2_STATUS_SHIFT			3
#define SMPS_SR2_STATUS_MASK			(3 << 3)
#define SMPS_OPP_CHANGE				(1 << 2)
#define SMPS_OPP_SEL_SHIFT				0
#define SMPS_OPP_SEL_MASK				(3 << 0)

/* PRM_LDO_ABB_CTRL specific bits */
#define SMPS_SR2_WTCNT_VALUE_SHIFT			8
#define SMPS_SR2_WTCNT_VALUE_MASK			(0xff << 8)
#define SMPS_SLEEP_RBB_SEL				(1 << 3)
#define SMPS_ACTIVE_FBB_SEL				(1 << 2)
#define SMPS_ACTIVE_RBB_SEL				(1 << 1)
#define SMPS_SR2EN					(1 << 0)

//-----------------------------------------------------------------------------
// ABB related values
#define ABB_MAX_SETTLING_TIME	30 /* in us */
#define ABB_MAX_SETTLING_TIME_IN_TICKS	10 /* in ticks: this is ~30 us */
#define ABB_FAST_OPP			1
#define ABB_NOMINAL_OPP			2
#define ABB_SLOW_OPP			3
#define ABB_FAST_OPP_VAL        4
...
#define PRM_IRQENABLE_ABB_LDO_TRANXDONE_ST  (1 << 26)
