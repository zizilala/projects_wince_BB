...
#ifndef __AM3517_PRCM_H
#define __AM3517_PRCM_H
...
typedef struct {
    ...
    REG32 zzzReserved02[5];             // offset 0x005C
...
typedef struct {
    ...
    REG32 zzzReserved04[1];             // offset 0x00B4
    REG32 PM_WKST3_CORE;                // offset 0x00B8
    REG32 zzzReserved05[10];            // offset 0x00BC

    REG32 PM_PWSTST_CORE;               // offset 0x00E4 
    REG32 zzzReserved06[2];				// offset 0x00E8

    REG32 PM_WKEN3_CORE;                // offset 0x00F0 
    REG32 zzzReserved07[1];				// offset 0x00F4
...
typedef struct {
    ...
    REG32 zzzReserved08[1];             // offset 0x00E0 
    REG32 PM_PWSTST_xxx;                // offset 0x00E4 
    REG32 zzzReserved09[1];             // offset 0x00E8 

    REG32 zzzReserved10[1];             // offset 0x00EC
    REG32 PM_WKEN3_xxx;                 // offset 0x00F0
    REG32 zzzReserved11[1];				// offset 0x00F4
...
#define DPLL_MPU_CLKOUT_DIV_MASK			(UINT32)(0x1F << DPLL_MPU_CLKOUT_DIV_SHIFT)
#define DPLL_CORE_CLKOUT_DIV_MASK           (UINT32)(0x1F << DPLL_CORE_CLKOUT_DIV_SHIFT)
...
#define CM_CLKEN_SCMCTRL					(1 << 6)
#define CM_CLKEN_FSHOSTUSB                  (1 << 5)
#define CM_CLKEN_IPSS						(1 << 4)
...
#define CM_IDLEST_ST_UART4                  (1 << 23)
...
#define CM_IDLEST_ST_SCMCTRL				(1 << 6)
#define CM_IDLEST_ST_IPSS					(1 << 5) 
...
#define EMU_DPLL3_DIV_MASK					(0x1F << 16)
#define EMU_DPLL4_DIV_MASK					(0x1F << 24)
...
#define MPU_CLK_SRC_MASK					(0x7 << 19)
...
#define PRM_SYSCLKDIV_OFFSET				(6)
#define PRM_SYSCLKDIV_MASK					(0x3 << PRM_SYSCLKDIV_OFFSET)
