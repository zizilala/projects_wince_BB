...
//
#ifndef __AM3517_BASE_REGS_H
#define __AM3517_BASE_REGS_H
...
#define OMAP_USBD_REGS_PA                       0x4805E200
...
#define OMAP_USBHS_REGS_PA                      0x5C040000
...
#define OMAP_CPGMAC_REGS_PA                    (0x5C000000)
#define OMAP_CPGMAC_SUBSYS_REGS_PA             (OMAP_CPGMAC_REGS_PA)
#define OMAP_CPGMAC_MODULE_REGS_PA             (OMAP_CPGMAC_REGS_PA + 0x10000)
#define OMAP_CPGMAC_CPPIBUFFERS_PA             (OMAP_CPGMAC_REGS_PA + 0x20000)
#define OMAP_CPGMAC_MDIO_REGS_PA               (OMAP_CPGMAC_REGS_PA + 0x30000)

//------------------------------------------------------------------------------
//  CAN HECC
//------------------------------------------------------------------------------

#define OMAP_HECC_REGS_PA						0x5C050000

//------------------------------------------------------------------------------
// VPFE (Video Processing Front End)
//------------------------------------------------------------------------------

#define OMAP_VPFE_REGS_PA						0x5c060000
