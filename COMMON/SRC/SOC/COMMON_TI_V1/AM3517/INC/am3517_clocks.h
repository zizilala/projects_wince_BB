...
//------------------------------------------------------------------------------
#define OMAP3517_GENERIC        0xFFFFFFFF
...
typedef enum {
    ...
    OMAP_DEVICE_GPTIMER7,        //--60--
    OMAP_DEVICE_GPTIMER8,
    OMAP_DEVICE_GPTIMER9,    
    OMAP_DEVICE_UART3,
    OMAP_DEVICE_WDT3,       
    ...
    OMAP_DEVICE_VPFE,
    OMAP_DEVICE_CSI2,            //--70--
    OMAP_DEVICE_2D,              // GFX domain clocks
    OMAP_DEVICE_3D,
	...
	OMAP_DEVICE_EHCI,
	OMAP_DEVICE_VRFB,           //--80--
    OMAP_DEVICE_STUB1,			// Need to let the SGX at index 0x48
    OMAP_DEVICE_STUB2,          // Need to let the SGX at index 0x48
    OMAP_DEVICE_STUB3,          // Need to let the SGX at index 0x48
    OMAP_DEVICE_SGX = 0x48,		// For legacy reasons, SGX must be 0x48 such as 
								//  used in the PowerVR drivers
	OMAP_DEVICE_GENERIC,			
