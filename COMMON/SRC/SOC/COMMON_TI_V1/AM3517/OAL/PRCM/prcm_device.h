...
AUTOIDLE_DECL(_autoIdle_IPSS, FALSE,   CM_CLKEN_IPSS,   cm_offset(CM_AUTOIDLE1_xxx));
AUTOIDLE_DECL(_autoIdle_SCMCTRL, FALSE,CM_CLKEN_SCMCTRL,cm_offset(CM_AUTOIDLE1_xxx));
...
// CORE
IDLESTAT_DECL(_idleStat_IPSS,	CM_IDLEST_ST_IPSS,		cm_offset(CM_IDLEST1_xxx));
IDLESTAT_DECL(_idleStat_SCMCTRL,	CM_IDLEST_ST_SCMCTRL,	cm_offset(CM_IDLEST1_xxx));
...
IDLESTAT_DECL(_idleStat_UART4,   CM_IDLEST_ST_UART4, 	cm_offset(CM_IDLEST1_xxx));
...
// DSS
IDLESTAT_DECL(_idleStat_DSS,	   CM_IDLEST_ST_DSS,	cm_offset(CM_IDLEST_xxx));

// USBHOST
IDLESTAT_DECL(_idleStat_USBHOST,CM_IDLEST_ST_USBHOST_STDBY,	cm_offset(CM_IDLEST_xxx));
...
ICLK_DECL(_iclk_IPSS,    0, CM_CLKEN_IPSS,	cm_offset(CM_ICLKEN1_xxx));
ICLK_DECL(_iclk_SCMCTRL, 0, CM_CLKEN_SCMCTRL, cm_offset(CM_ICLKEN1_xxx));
ICLK_DECL(_iclk_HDQ,	  0, CM_CLKEN_HDQ,		cm_offset(CM_ICLKEN1_xxx));
ICLK_DECL(_iclk_UART4,	  0, CM_CLKEN_UART4,	cm_offset(CM_ICLKEN1_xxx));
...
ICLK_DECL(_iclk_USBHOST1, 0, 0, cm_offset(CM_ICLKEN_xxx));
ICLK_DECL(_iclk_USBHOST2, 0, 0, cm_offset(CM_ICLKEN_xxx));
ICLK_DECL(_iclk_USBHOST3, 0, 0, cm_offset(CM_ICLKEN_xxx));
...
FCLK_DECL(_fclk_HDQ,    0, CM_CLKEN_HDQ,    cm_offset(CM_FCLKEN_xxx));
...
// DSS
FCLK_DECL(_fclk_DSS  , 0, CM_CLKEN_DSS1,	cm_offset(CM_FCLKEN_xxx));
...
// USBHOST
FCLK_DECL(_fclk_USBOHCI,  0, CM_CLKEN_HSUSB1, cm_offset(CM_FCLKEN_xxx));
FCLK_DECL(_fclk_USBEHCI, 0, CM_CLKEN_HSUSB2, cm_offset(CM_FCLKEN_xxx));
...
WKEN_DECL(_wken_GPT12,  CM_CLKEN_GPT12,	prm_offset(PM_WKEN_xxx));
...
DeviceLookupEntry s_rgDeviceLookupTable[] =
{
    ...
    //-------------------
        ...
        POWERDOMAIN_CORE,                       // OMAP_DEVICE_IPSS
        NULL,
        &_iclk_IPSS,
        NULL,
        &_idleStat_IPSS,
        ...
        POWERDOMAIN_CORE,                       // OMAP_DEVICE_SCMCTRL
        NULL,
        &_iclk_SCMCTRL,
        NULL,
        &_idleStat_SCMCTRL,
...
// DSS domain clocks    
        ...
        {
// VPFE clock is manage by IPSS
        POWERDOMAIN_PERIPHERAL,                     // OMAP_DEVICE_VPFE
        NULL,
        NULL,
        NULL,
        NULL,
     ...
     {
        POWERDOMAIN_PERIPHERAL,                     // OMAP_DEVICE_CSI2
        NULL,
        NULL,
        NULL,
        NULL,
        ...
        POWERDOMAIN_SGX,                        // OMAP_DEVICE_2D
        NULL,    
        NULL,
        NULL,
        NULL,     
        ...
        POWERDOMAIN_USBHOST,                    // OMAP_DEVICE_OHCI
        &_fclk_USBOHCI,    
        &_iclk_USBHOST,
        &_wken_USBHOST,
        &_idleStat_USBHOST,     
        ...
        POWERDOMAIN_USBHOST,                    // OMAP_DEVICE_EHCI
        &_fclk_USBEHCI,    
        &_iclk_USBHOST,
        &_wken_USBHOST,
        &_idleStat_USBHOST,     
        ...
        POWERDOMAIN_PERIPHERAL,                     // OMAP_DEVICE_STUB1
        NULL,
        NULL,
        NULL,
        NULL,
        ...
        POWERDOMAIN_PERIPHERAL,                     // OMAP_DEVICE_STUB2
        NULL,   
        NULL,
        NULL,
        NULL,
        ...
        POWERDOMAIN_PERIPHERAL,                     // OMAP_DEVICE_STUB3
        NULL,
        NULL,
        NULL,
        NULL,
