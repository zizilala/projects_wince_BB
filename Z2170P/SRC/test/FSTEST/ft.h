...
//
BEGIN_FTE
    FTH(  0,   "File System Performance Tests")
    FTE( 10,   "Sequential access using 256B buffers",     10,       ( 256), TestProc_FileSystem)
    FTE( 20,   "Sequential access using 1KB buffers",      20,       (1024), TestProc_FileSystem)
    FTE( 30,   "Sequential access using 2KB buffers",      30, (  2 * 1024), TestProc_FileSystem)
    FTE( 40,   "Sequential access using 8KB buffers",      40, (  8 * 1024), TestProc_FileSystem)
    FTE( 50,   "Sequential access using 16KB buffers",     50, ( 16 * 1024), TestProc_FileSystem)
    FTE( 60,   "Sequential access using 32KB buffers",     60, ( 32 * 1024), TestProc_FileSystem)
    FTE( 70,   "Sequential access using 64KB buffers",     70, ( 64 * 1024), TestProc_FileSystem)
    FTE( 80,   "Sequential access using 128KB buffers",    80, (128 * 1024), TestProc_FileSystem)
    FTE( 90,   "Sequential access using 256KB buffers",    90, (256 * 1024), TestProc_FileSystem)
    FTE(100,   "Sequential access using custom buffers",  100,            0, TestProc_FileSystem)
END_FTE
