...
BEGIN_FTE
    FTH(0, "Power Manager Test Cases")		
	FTE(1,		"Power State Test", 1000, 0, TestPowerStates)
	FTE(1,		"State Transition Test", 1001, 0, TestSystemStateMachine)
	FTE(1,		"Suspend/Resume Test", 1002, 0, TestSuspendResume)
