...
DWORD	g_StressCount = 1;
DWORD	g_NbLoop = 1;
DWORD	g_TimeToSleep = 60; // in seconds
DWORD   g_NbBytes=2;
...
{
    static  TCHAR   szHeader[] = TEXT("Tux_PowerManagement: ");
    TCHAR   szBuffer[1024];
...
SHELLPROCAPI ShellProc(UINT uMsg, SPPARAM spParam)
{
    ...
    case SPM_BEGIN_GROUP:
        ...
        g_pKato->BeginLevel(0, TEXT("BEGIN GROUP: Tux_PowerManagement.DLL"));
        break;
    ...
    case SPM_END_GROUP:
        ...
        g_pKato->EndLevel(TEXT("END GROUP: Tux_PowerManagement.DLL"));
        break;
...
static BOOL  SetTestOptions( LPTSTR lpszCmdLine )
{
    ...
    while( '\0' != lpszCmdLine[iCmdIdx] )
    {
        ...
        case CmdItr:
            {
				g_fStress = TRUE;
                pdwVariable = &g_StressCount;
                break;
            }
        case CmdLoop:
            {
                pdwVariable = &g_NbLoop;
                break;
            }
        case CmdSleep:
            {
                pdwVariable = &g_TimeToSleep;
                break;
            }
        case CmdBytes:
            {
                pdwVariable = &g_NbBytes;
                break;
            }    
