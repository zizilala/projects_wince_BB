...
{
    static  TCHAR   szHeader[] = TEXT("Tux_I2C: ");
    TCHAR   szBuffer[1024];
...
SHELLPROCAPI ShellProc(UINT uMsg, SPPARAM spParam)
{
    ...
    case SPM_BEGIN_GROUP:
        ...
        g_pKato->BeginLevel(0, TEXT("BEGIN GROUP: Tux_I2C.DLL"));
        break;
    ...
    case SPM_END_GROUP:
        ...
        g_pKato->EndLevel(TEXT("END GROUP: Tux_I2C.DLL"));
        break;
...
static BOOL  SetTestOptions( LPTSTR lpszCmdLine )
{
    ...
    while( '\0' != lpszCmdLine[iCmdIdx] )
    {
        ...
        case CmdAddress:
            {
                pdwVariable = &g_Address;
                break;
            }
		case CmdBaudRateIndex:
            {
                pdwVariable = &g_BaudRateIndex;
                break;
            }
		case CmdSubAddressMode:
            {
                pdwVariable = &g_SubAddressMode;
                break;
            }
        default:
