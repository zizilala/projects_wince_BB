...
extern DWORD	   g_BaudRateIndex;
extern DWORD	   g_SubAddressMode;
...
static const  TCHAR CmdAddress      = (TCHAR)'a';
static const  TCHAR CmdBaudRateIndex    = (TCHAR)'r';
static const  TCHAR CmdSubAddressMode    = (TCHAR)'s';
