...
{       \
    ...
    PAD_ENTRY(SDRC_CLK            ,INPUT_ENABLED | MUXMODE(0))    \
    PAD_ENTRY(SDRC_DQS0           ,INPUT_ENABLED | MUXMODE(0))    \
    PAD_ENTRY(SDRC_DQS1           ,INPUT_ENABLED | MUXMODE(0))    \
    PAD_ENTRY(SDRC_DQS2           ,INPUT_ENABLED | MUXMODE(0))    \
    PAD_ENTRY(SDRC_DQS3           ,INPUT_ENABLED | MUXMODE(0))    \
    PAD_ENTRY(SDRC_CKE0           ,INPUT_ENABLED | MUXMODE(0))    \
    PAD_ENTRY(SDRC_CKE1           ,INPUT_ENABLED | MUXMODE(0))    \
    ...
    PAD_ENTRY(GPMC_nBE1           ,RELEASED_PAD_DEFAULT_CONFIG)		\
    ...
    PAD_ENTRY(UART3_CTS_RCTX      ,INPUT_ENABLED | PULL_RESISTOR_ENABLED | PULLDOWN_RESISTOR | MUXMODE(0))     \
    PAD_ENTRY(UART3_RTS_SD        ,INPUT_DISABLED | MUXMODE(0))     \
    PAD_ENTRY(UART3_RX_IRRX       ,INPUT_ENABLED | PULL_RESISTOR_DISABLED | PULLDOWN_RESISTOR | MUXMODE(0))     \
    PAD_ENTRY(UART3_TX_IRTX       ,INPUT_DISABLED | MUXMODE(0))     \
	PAD_ENTRY(HSUSB0_CLK		  ,RELEASED_PAD_DEFAULT_CONFIG)     \
	PAD_ENTRY(HSUSB0_STP		  ,RELEASED_PAD_DEFAULT_CONFIG)     \
	PAD_ENTRY(HSUSB0_DIR		  ,RELEASED_PAD_DEFAULT_CONFIG)     \
	PAD_ENTRY(HSUSB0_NXT		  ,RELEASED_PAD_DEFAULT_CONFIG)     \
	PAD_ENTRY(HSUSB0_DATA0		  ,RELEASED_PAD_DEFAULT_CONFIG)     \
	PAD_ENTRY(HSUSB0_DATA1		  ,RELEASED_PAD_DEFAULT_CONFIG)     \
	PAD_ENTRY(HSUSB0_DATA2		  ,RELEASED_PAD_DEFAULT_CONFIG)     \
	PAD_ENTRY(HSUSB0_DATA3		  ,RELEASED_PAD_DEFAULT_CONFIG)     \
	PAD_ENTRY(HSUSB0_DATA4		  ,RELEASED_PAD_DEFAULT_CONFIG)     \
	PAD_ENTRY(HSUSB0_DATA5		  ,RELEASED_PAD_DEFAULT_CONFIG)     \
	PAD_ENTRY(HSUSB0_DATA6		  ,RELEASED_PAD_DEFAULT_CONFIG)     \
	PAD_ENTRY(HSUSB0_DATA7		  ,RELEASED_PAD_DEFAULT_CONFIG)     \
    ...
    PAD_ENTRY(MCSPI1_CS2          ,RELEASED_PAD_DEFAULT_CONFIG)     \
    ...
    PAD_ENTRY(MCSPI2_CS0          ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(MCSPI2_CS1          ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(SYS_NIRQ            ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(SAD2D_MCAD0         ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(SAD2D_MCAD2         ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(SAD2D_MCAD4         ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(SAD2D_MCAD6         ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(SAD2D_MCAD8         ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(SAD2D_MCAD10        ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(SAD2D_MCAD12        ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(SAD2D_MCAD14        ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(SAD2D_MCAD16        ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(SAD2D_MCAD18        ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(SAD2D_MCAD20        ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(SAD2D_MCAD22        ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(SAD2D_MCAD24        ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(SAD2D_MCAD26        ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(SAD2D_MCAD28        ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(SAD2D_MCAD30        ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(SAD2D_MCAD32        ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(SAD2D_MCAD34        ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(SAD2D_MCAD36        ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(SAD2D_ARMNIRQ       ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(SAD2D_SPINT         ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(SAD2D_DMAREQ0       ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(SAD2D_DMAREQ2       ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(SAD2D_NTRST         ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(SAD2D_TDO           ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(SAD2D_TCK           ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(SAD2D_SWRITE        ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(SAD2D_SREAD         ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(SAD2D_SBUSFLAG      ,RELEASED_PAD_DEFAULT_CONFIG)     \
    ...
    PAD_ENTRY(CAM_XCLKA           ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(CAM_PCLK            ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(CAM_VS              ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(CAM_HS              ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(CAM_FLD             ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(CAM_D1              ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(CAM_D2              ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(CAM_D3              ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(CAM_D4              ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(CAM_D5              ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(CAM_D6              ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(CAM_D7              ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(CAM_D9              ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(CAM_D8              ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(CAM_D10             ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(CAM_D11             ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(CAM_XCLKB           ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(CAM_D0              ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(CAM_WEN             ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(CAM_STROBE          ,RELEASED_PAD_DEFAULT_CONFIG)     \
    PAD_ENTRY(CSI2_DX0			  ,RELEASED_PAD_DEFAULT_CONFIG)     \
    ...
    WKUP_PAD_ENTRY(SYS_BOOT0      ,SAFE_INPUT_PULLUP)     \
    WKUP_PAD_ENTRY(SYS_BOOT1      ,SAFE_INPUT_PULLUP)     \
    ...
    WKUP_PAD_ENTRY(SYS_CLKREQ     ,INPUT_DISABLED | PULL_RESISTOR_ENABLED | PULLDOWN_RESISTOR | MUXMODE(0))     \
    WKUP_PAD_ENTRY(SYS_OFF_MODE   ,INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(0))     \
    /*WKUP_PAD_ENTRY(GPIO126	      ,INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(4))*/     \
    END_OF_PAD_ARRAY                                                \
}
...
#define DSS_PADS_37XX  \
    ...
    PAD_ENTRY(DSS_DATA6           ,INPUT_DISABLED | MUXMODE(0)) /* DSS_DATA 6 */ \
    PAD_ENTRY(DSS_DATA7           ,INPUT_DISABLED | MUXMODE(0)) /* DSS_DATA 7 */ \
    PAD_ENTRY(DSS_DATA8           ,INPUT_DISABLED | MUXMODE(0)) /* DSS_DATA 8 */ \
    PAD_ENTRY(DSS_DATA9           ,INPUT_DISABLED | MUXMODE(0)) /* DSS_DATA 9 */ \
    PAD_ENTRY(DSS_DATA10          ,INPUT_DISABLED | MUXMODE(0)) /* DSS_DATA 10 */ \
    PAD_ENTRY(DSS_DATA11          ,INPUT_DISABLED | MUXMODE(0)) /* DSS_DATA 11 */ \
    PAD_ENTRY(DSS_DATA12          ,INPUT_DISABLED | MUXMODE(0)) /* DSS_DATA 12 */ \
    PAD_ENTRY(DSS_DATA13          ,INPUT_DISABLED | MUXMODE(0)) /* DSS_DATA 13 */ \
    PAD_ENTRY(DSS_DATA14          ,INPUT_DISABLED | MUXMODE(0)) /* DSS_DATA 14 */ \
    PAD_ENTRY(DSS_DATA15          ,INPUT_DISABLED | MUXMODE(0)) /* DSS_DATA 15 */ \
    PAD_ENTRY(DSS_DATA16          ,INPUT_DISABLED | MUXMODE(0)) /* DSS_DATA 16 */ \
    PAD_ENTRY(DSS_DATA17          ,INPUT_DISABLED | MUXMODE(0)) /* DSS_DATA 17 */ \
    ...
    WKUP_PAD_ENTRY(SYS_BOOT0	,INPUT_DISABLED | MUXMODE(3)) /* DSS_DATA 18 */ \
    WKUP_PAD_ENTRY(SYS_BOOT1	,INPUT_DISABLED | MUXMODE(3)) /* DSS_DATA 19 */ \
    WKUP_PAD_ENTRY(SYS_BOOT3	,INPUT_DISABLED | MUXMODE(3)) /* DSS_DATA 20 */ \
    WKUP_PAD_ENTRY(SYS_BOOT4	,INPUT_DISABLED | MUXMODE(3)) /* DSS_DATA 21 */ \
    WKUP_PAD_ENTRY(SYS_BOOT5	,INPUT_DISABLED | MUXMODE(3)) /* DSS_DATA 22 */ \
    WKUP_PAD_ENTRY(SYS_BOOT6	,INPUT_DISABLED | MUXMODE(3)) /* DSS_DATA 23 */ \
    PAD_ENTRY(MCBSP4_DX			,INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(4)) /* GPIO 154 LCM_PWEN */ \
    PAD_ENTRY(UART2_RX			,INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(4)) /* GPIO 147 LCM_RST */ \
    PAD_ENTRY(GPMC_nBE1			,INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(4)) /* GPIO 61 BL_EN */
...
#define GPMC_PADS \
    ...
    PAD_ENTRY(GPMC_WAIT0,       INPUT_ENABLED | PULL_RESISTOR_ENABLED | PULLUP_RESISTOR | MUXMODE(0))      \
    PAD_ENTRY(GPMC_WAIT1,       INPUT_ENABLED | MUXMODE(4))      
...
#define UART3_PADS \
    PAD_ENTRY(UART3_TX_IRTX , INPUT_DISABLED | MUXMODE(0))      \
    PAD_ENTRY(UART3_RTS_SD  , INPUT_DISABLED | MUXMODE(0))      \
    PAD_ENTRY(UART3_CTS_RCTX, INPUT_ENABLED | MUXMODE(0))       \
    PAD_ENTRY(UART3_RX_IRRX , INPUT_ENABLED | MUXMODE(0))       

/* enable the commented lines when trying to configure 8-bit MMC */
#define MMC1_PADS   \
	...
	PAD_ENTRY(MMC1_DAT0, INPUT_ENABLED | PULL_RESISTOR_ENABLED | PULLUP_RESISTOR | MUXMODE(0)) \
	PAD_ENTRY(MMC1_DAT1, INPUT_ENABLED | PULL_RESISTOR_ENABLED | PULLUP_RESISTOR | MUXMODE(0)) \
	PAD_ENTRY(MMC1_DAT2, INPUT_ENABLED | PULL_RESISTOR_ENABLED | PULLUP_RESISTOR | MUXMODE(0)) \
	PAD_ENTRY(MMC1_DAT3, INPUT_ENABLED | PULL_RESISTOR_ENABLED | PULLUP_RESISTOR | MUXMODE(0))
...
/* 20130522-brian - for Touch panel */
#define MCSPI4_PADS \
    PAD_ENTRY(MCBSP1_FSX, INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(1)) \
    PAD_ENTRY(MCBSP1_DR,  INPUT_ENABLED | PULL_RESISTOR_DISABLED | MUXMODE(1)) \
    PAD_ENTRY(MCBSP1_DX,  INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(1)) \
    PAD_ENTRY(MCBSP1_CLKR,INPUT_ENABLED | PULL_RESISTOR_DISABLED | MUXMODE(1)) \
	PAD_ENTRY(MCBSP1_FSR,	INPUT_ENABLED | MUXMODE(4)) /* GPIO 157 : TOUCH TP_IRQ */
...
#define GPIO_PADS_37XX   \
	PAD_ENTRY(CSI2_DX0,	INPUT_ENABLED | MUXMODE(4)) /* GPIO 112 : WLAN_IRQ */ \
	PAD_ENTRY(MMC2_DAT4,INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(4)) /* GPIO 136 : VIBRATOR */ \
	PAD_ENTRY(ETK_D2,	INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(4)) /* GPIO 16 : WLAN_EN */ \
	PAD_ENTRY(ETK_D1,	INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(4)) /* GPIO 15 : BT_EN */ \
	PAD_ENTRY(GPMC_A1,	INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(4)) /* GPIO 34 : FM_EN */ \
	PAD_ENTRY(GPMC_A4,	INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(4)) /* GPIO 37 : SPK_EN */ \
	PAD_ENTRY(GPMC_A5,	INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(4)) /* GPIO 38 : ENG_PWEN */
...
#define USBH2_PADS	\
    PAD_ENTRY(ETK_D7,     INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(4)) /* GPIO 21	 (reset) */ \
    PAD_ENTRY(ETK_D8,     INPUT_DISABLED | PULL_RESISTOR_DISABLED | MUXMODE(4)) /* GPIO 22	 (power) */ \
    ...
    PAD_ENTRY(ETK_D11,    INPUT_ENABLED  | PULL_RESISTOR_DISABLED | PULLUP_RESISTOR | MUXMODE(3)) /* HSUSB2_STP */ \
    PAD_ENTRY(ETK_D12,    INPUT_ENABLED  | PULL_RESISTOR_ENABLED  | MUXMODE(3)) /* HSUSB2_DIR */ \
    PAD_ENTRY(ETK_D13,    INPUT_ENABLED  | PULL_RESISTOR_DISABLED | MUXMODE(3)) /* HSUSB2_NXT */

#define USBOTG_PADS \
    PAD_ENTRY(HSUSB0_STP,   INPUT_ENABLED  | PULL_RESISTOR_ENABLED  | PULLUP_RESISTOR | MUXMODE(0)) /* HSUSB0_STP   */ \
	PAD_ENTRY(HSUSB0_CLK,   INPUT_ENABLED  | PULL_RESISTOR_DISABLED | MUXMODE(0)) /* HSUSB0_CLK   */ \
	PAD_ENTRY(HSUSB0_DIR,   INPUT_ENABLED  | PULL_RESISTOR_DISABLED | MUXMODE(0)) /* HSUSB0_DIR   */ \
    PAD_ENTRY(HSUSB0_NXT,   INPUT_ENABLED  | PULL_RESISTOR_DISABLED | MUXMODE(0)) /* HSUSB0_NXT   */ \
    PAD_ENTRY(HSUSB0_DATA0, INPUT_ENABLED  | PULL_RESISTOR_DISABLED | MUXMODE(0)) /* HSUSB0_DATA0 */ \
    PAD_ENTRY(HSUSB0_DATA1, INPUT_ENABLED  | PULL_RESISTOR_DISABLED | MUXMODE(0)) /* HSUSB0_DATA1 */ \
    PAD_ENTRY(HSUSB0_DATA2, INPUT_ENABLED  | PULL_RESISTOR_DISABLED | MUXMODE(0)) /* HSUSB0_DATA2 */ \
	PAD_ENTRY(HSUSB0_DATA3, INPUT_ENABLED  | PULL_RESISTOR_DISABLED | MUXMODE(0)) /* HSUSB0_DATA3 */ \
    PAD_ENTRY(HSUSB0_DATA4, INPUT_ENABLED  | PULL_RESISTOR_DISABLED | MUXMODE(0)) /* HSUSB0_DATA4 */ \
    PAD_ENTRY(HSUSB0_DATA5, INPUT_ENABLED  | PULL_RESISTOR_DISABLED | MUXMODE(0)) /* HSUSB0_DATA5 */ \
    PAD_ENTRY(HSUSB0_DATA6, INPUT_ENABLED  | PULL_RESISTOR_DISABLED | MUXMODE(0)) /* HSUSB0_DATA6 */ \
	PAD_ENTRY(HSUSB0_DATA7, INPUT_ENABLED  | PULL_RESISTOR_DISABLED | MUXMODE(0)) /* HSUSB0_DATA7 */

#define CAMERA_PADS	\
    PAD_ENTRY(CAM_XCLKA, INPUT_ENABLED  | PULL_RESISTOR_ENABLED | PULLUP_RESISTOR | MUXMODE(0)) /*  */ \
    PAD_ENTRY(CAM_PCLK,  INPUT_ENABLED  | PULL_RESISTOR_ENABLED | PULLUP_RESISTOR | MUXMODE(0)) /*  */ \
    PAD_ENTRY(CAM_VS,    INPUT_ENABLED  | PULL_RESISTOR_ENABLED | PULLUP_RESISTOR | MUXMODE(0)) /*  */ \
    PAD_ENTRY(CAM_HS,    INPUT_ENABLED  | PULL_RESISTOR_ENABLED | PULLUP_RESISTOR | MUXMODE(0)) /*  */ \
    PAD_ENTRY(CAM_FLD,   INPUT_ENABLED  | PULL_RESISTOR_ENABLED | PULLUP_RESISTOR | MUXMODE(4)) /*  */ \
    PAD_ENTRY(CAM_D1,    INPUT_ENABLED  | PULL_RESISTOR_DISABLED | MUXMODE(0)) /*  */ \
    PAD_ENTRY(CAM_D2,    INPUT_ENABLED  | PULL_RESISTOR_DISABLED | MUXMODE(0)) /*  */ \
    PAD_ENTRY(CAM_D3,    INPUT_ENABLED  | PULL_RESISTOR_DISABLED | MUXMODE(0)) /*  */ \
    PAD_ENTRY(CAM_D4,    INPUT_ENABLED  | PULL_RESISTOR_DISABLED | MUXMODE(0)) /*  */ \
    PAD_ENTRY(CAM_D5,    INPUT_ENABLED  | PULL_RESISTOR_DISABLED | MUXMODE(0)) /*  */ \
    PAD_ENTRY(CAM_D6,    INPUT_ENABLED  | PULL_RESISTOR_DISABLED | MUXMODE(0)) /*  */ \
    PAD_ENTRY(CAM_D7,    INPUT_ENABLED  | PULL_RESISTOR_DISABLED | MUXMODE(0)) /*  */ \
    PAD_ENTRY(CAM_D9,    INPUT_ENABLED  | PULL_RESISTOR_DISABLED | MUXMODE(0)) /*  */ \
    PAD_ENTRY(CAM_D8,    INPUT_ENABLED  | PULL_RESISTOR_DISABLED | MUXMODE(0)) /*  */ \
    PAD_ENTRY(CAM_D10,   INPUT_ENABLED  | PULL_RESISTOR_DISABLED | MUXMODE(0)) /*  */ \
    PAD_ENTRY(CAM_D11,   INPUT_ENABLED  | PULL_RESISTOR_DISABLED | MUXMODE(0)) /*  */ \
    PAD_ENTRY(CAM_XCLKB, INPUT_ENABLED  | PULL_RESISTOR_DISABLED | MUXMODE(0)) /*  */ \
    PAD_ENTRY(CAM_D0,    INPUT_ENABLED  | PULL_RESISTOR_DISABLED | MUXMODE(0)) /*  */ \
    PAD_ENTRY(CAM_WEN,   INPUT_ENABLED  | PULL_RESISTOR_DISABLED | MUXMODE(0)) /*  */ \
    PAD_ENTRY(CAM_STROBE,INPUT_ENABLED  | PULL_RESISTOR_DISABLED | MUXMODE(0)) /*  */ 
