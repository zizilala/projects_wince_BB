...
DdsiTouchPanelEnable()
{
	...
	DWORD dwLogIntr = GPIOGetSystemIrq(s_TouchDevice.hGPIO,s_TouchDevice.nPenGPIO); // 285 = 128 + 157
	...
	//brian KernelIoControl(IOCTL_HAL_ENABLE_WAKE, &gIntrTouch,sizeof(gIntrTouch), NULL, 0, NULL);
