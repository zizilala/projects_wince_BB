...
#define DEFAULT_SAMPLE_RATE_HZ          90//200
#define TOUCHPANEL_SAMPLE_RATE_LOW      150//DEFAULT_SAMPLE_RATE_HZ
#define TOUCHPANEL_SAMPLE_RATE_HIGH     150//DEFAULT_SAMPLE_RATE_HZ
