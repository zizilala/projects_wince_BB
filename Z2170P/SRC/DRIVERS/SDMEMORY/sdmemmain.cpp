    ...
    )
{
    ...
    switch(IoctlCode) {
        ...
        case IOCTL_POWER_CAPABILITIES:
        {
            ...
            SafePowerCapabilities.DeviceDx = (UCHAR)(DX_MASK(D0) | DX_MASK(pHandle->PowerStateForIdle));

            SafePowerCapabilities.Power[D0] = (DWORD)PwrDeviceUnspecified;
            SafePowerCapabilities.Power[D1] = (DWORD)PwrDeviceUnspecified;
            SafePowerCapabilities.Power[D2] = (DWORD)PwrDeviceUnspecified;
            SafePowerCapabilities.Power[D3] = (DWORD)PwrDeviceUnspecified;
            SafePowerCapabilities.Power[D4] = (DWORD)PwrDeviceUnspecified;
        ...
        case IOCTL_POWER_GET:
            ...
            *(PCEDEVICE_POWER_STATE)pOutBuf = pHandle->CurrentPowerState;
            break;
